...
import ShowWithPreviewTile from './ShowWithPreviewTile';

const ShowsWithPreviewRow = ({ title, shows }) => {
    ...
    function rowRenderer(type, data) {
        switch (type) {
            case 0:
                return (
                    <ShowWithPreviewTile showDetails={data}></ShowWithPreviewTile>
                );
            default:
                return null;
        }
...
export default ShowsWithPreviewRow;